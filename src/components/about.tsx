function About() {
  return (
    ...
    >
      ...
      <p className=" p-3 sm:px-40 text-center text-xl sm:text-2xl tracking-wider leading-9 sm:leading-12">
        ...
        explore the depths of backend development. Currently, I’m honing my
        skills in Node.js, MongoDB, and Express, focusing on building robust and
